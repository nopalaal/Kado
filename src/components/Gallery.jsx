...
import memory3 from '../assets/memory (12).jpeg'
import memory4 from '../assets/memory (1).jpeg'
import memory5 from '../assets/memory (7).jpeg'
import memory6 from '../assets/memory (8).jpeg'
import memory7 from '../assets/memory (23).jpeg'
import memory8 from '../assets/memory (13).jpeg'
import memory9 from '../assets/memory (10).jpeg'
...
//foto
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: memory1, text: "manjat gunung" },
      { image: memory2, text: "lagi nugas" },
      { image: memory3, text: "dokter" },
      { image: memory4, text: "si gemesin" },
      { image: memory5, text: "natal pertama" },
      { image: memory6, text: "gorgeous" },
      { image: memory7, text: "day1 jadian" },
      { image: memory8, text: "makan" },
      { image: memory9, text: "rebahan" },
      { image: memory10, text: "cantik banget asliefauofefnaepif" },
...
export default function CircularGallery({
  ...
  return (
    <div className="w-full h-[500px] flex flex-col items-center bg-pink-300 justify-centerbg-purple-300 p-6 pt-8 pb-12 overflow-hidden">
      ...
      <div
        className="w-full h-full overflow-hidden rounded-lg cursor-grab active:cursor-grabbing mt-4"
        ref={containerRef}
      >
      </div>
    </div>
